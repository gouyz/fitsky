...
private let venueHomeListCell = "venueHomeListCell"

class FSVenueHomeListVC: GYZWhiteNavBaseVC {
    ...
    lazy var tableView : UITableView = {
        ...
        table.register(FSPersonHomeListCell.classForCoder(), forCellReuseIdentifier: venueHomeListCell)
...
extension FSVenueHomeListVC: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: venueHomeListCell) as! FSPersonHomeListCell
...
extension FSVenueHomeListVC: JXPagingViewListViewDelegate {
