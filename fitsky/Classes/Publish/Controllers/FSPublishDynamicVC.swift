...
class FSPublishDynamicVC: GYZWhiteNavBaseVC {
    ...
    ///txtView 提示文字
    let placeHolder = "分享我的动态"
    //// 最大字数
    let contentMaxCount: Int = 120
    /// 选择的图片
    ...
    func setUpUI(){
        ...
        addressView.snp.makeConstraints { (make) in
            make.left.right.height.equalTo(topicView)
            make.top.equalTo(seePowerView.snp.bottom).offset(5)
...
extension FSPublishDynamicVC : UIImagePickerControllerDelegate,UINavigationControllerDelegate
{
...
extension FSPublishDynamicVC : UITextViewDelegate,LHSAddPhotoViewDelegate
{
