...
@interface DOPDropDownMenu (){
    struct {
        ...
        unsigned int titleForHeaderInColumn :1;
...
//    [self.bgLayers makeObjectsPerformSelector:@selector(removeFromSuperlayer)];
    ...
    _dataSourceFlags.titleForHeaderInColumn = [_dataSource respondsToSelector:@selector(menu:titleForHeaderInColumn:)];
...
//        }
        titleString =[_dataSource menu:self titleForHeaderInColumn:i];
