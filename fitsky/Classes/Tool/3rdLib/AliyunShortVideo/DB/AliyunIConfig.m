...
- (instancetype)init {
    self = [super init];
    if (self) {
        _backgroundColor = [UIColor colorWithRed:35/255.0 green:42/255.0 blue:66/255.0 alpha:1.0];
        _timelineBackgroundCollor = [UIColor colorWithWhite:0 alpha:0.34];
        _timelineDeleteColor = [UIColor redColor];
        _timelineTintColor = [UIColor colorWithRed:252/255.0 green:68/255.0 blue:72/255.0 alpha:1.0];
