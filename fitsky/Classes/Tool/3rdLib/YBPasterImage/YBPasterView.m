...
- (void)hiddenBtn
{
    [UIView animateWithDuration:.5 animations:^{
        ...
        self.pasterImageView.layer.borderColor = [UIColor clearColor].CGColor;
    }];
}
...
- (void)showBtn
{
    [UIView animateWithDuration:.5 animations:^{
        ...
        self.pasterImageView.layer.borderColor = [UIColor whiteColor].CGColor;
    }];
}
...
//    pasterImageView.backgroundColor = [UIColor clearColor];
    ...
    UITapGestureRecognizer *pasterTap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(btPasterViewPressed:)];
    pasterImageView.userInteractionEnabled = YES;
    [pasterImageView addGestureRecognizer:pasterTap];
 ...
 *  点击手势
 */
- (void)btPasterViewPressed:(UITapGestureRecognizer *)recognizer
{
    if (self.delegate && [self.delegate respondsToSelector:@selector(showEditThePaster:)])
    {
        [self.delegate showEditThePaster:self];
    }
