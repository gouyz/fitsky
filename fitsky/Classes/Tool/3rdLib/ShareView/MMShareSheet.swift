...
let ss_mmcardHeight:CGFloat = 80.0 * ss_mmscreenWidth / 375   /* 单行card的高度 */
let ss_mmitemHeight:CGFloat = 60.0 * ss_mmscreenWidth / 375   /* 单个item的高度 */
let ss_mmitemwidth:CGFloat = 60 * ss_mmscreenWidth / 375    /* 单个item的宽度 */
