...
//    [dic setObject:userId forKey:@"other_member_id"];
    
//    [SendRequest getUserInfo:dic result:^(id result, NSError *error) {
...
//
//            rcUser.name = [userInfo objectForKey:@"alias"];
//            rcUser.portraitUri = [userInfo objectForKey:@"head_url"];
//            rcUser.userId = userId;
//        }else{
//            rcUser.userId = userId;
//            rcUser.portraitUri = @"";
//            rcUser.name = [NSString stringWithFormat:@"name%@", userId];
//        }
//        completion(rcUser);
//    }];
    completion(nil);
