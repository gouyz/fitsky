...
class FSFoodStoreManagerVC: GYZWhiteNavBaseVC {
    ...
    func requestCategoryList(){
        ...
        GYZNetWork.requestNetwork("Cookbook/Food/category",parameters: nil,  success: { (response) in
...
extension FSFoodStoreManagerVC: JXSegmentedViewDelegate {
