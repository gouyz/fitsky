//
//  FSCustomPhotoBrowserCell.swift
//  fitsky
//  自定义大图预览 cell
//  Created by iMac on 2020/5/13.
...
class FSCustomPhotoBrowserCell: UIView, UIScrollViewDelegate, UIGestureRecognizerDelegate, JXPhotoBrowserCell {
    /// 弱引用PhotoBrowser
    ...
    // 长按事件
    public typealias LongPressAction = (FSCustomPhotoBrowserCell, UILongPressGestureRecognizer) -> Void
