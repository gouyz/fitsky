...
private let allWorksCell = "allWorksCell"

class FSAllWorksVC: GYZWhiteNavBaseVC {
...
//        }
    ...
    lazy var tableView : UITableView = {
        ...
        table.register(FSZongHeCell.classForCoder(), forCellReuseIdentifier: allWorksCell)
    ...
    func requestFriendWorksList(){
        ...
        GYZNetWork.requestNetwork("Dynamic/Dynamic/opus",parameters: ["p":currPage,"friend_id":userId,"category_id":categoryId],  success: { (response) in
            ...
            if response["result"].intValue == kQuestSuccessTag{//请求成功
                ...
                if weakSelf?.dataList.count > 0{
                    ...
                    ///显示空页面
                    weakSelf?.showEmptyView(content:"暂无作品信息")
                }
            ...
            if weakSelf?.currPage == 1{
                weakSelf?.showEmptyView(content: "加载失败，请点击重新加载", reload: {
                    weakSelf?.hiddenEmptyView()
                    weakSelf?.requestFriendWorksList()
                })
            }
...
extension FSAllWorksVC: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: allWorksCell) as! FSZongHeCell
        ...
        cell.imgViews.onClickedImgDetailsBlock = {[unowned self](index,urls) in
            if self.dataList[indexPath.row].video!.isEmpty {
                ...
                self.goWorksDetailVC(id: model.id!)
            }
        }
//        if indexPath.row == 0 {
...
//            cell.imgViews.imgHight = kScreenWidth - kMargin * 2
//            cell.imgViews.imgWidth = kScreenWidth - kMargin * 2
//            cell.imgViews.perRowItemCount = 1
//            cell.imgViews.selectImgUrls = [""]
//            cell.imgViews.snp.updateConstraints { (make) in
//                make.height.equalTo(kScreenWidth - kMargin * 2)
//            }
//        }else if indexPath.row == 2 {
//            cell.imgViews.isHidden = false
//            cell.imgViews.imgHight = kPhotosImgHeight2
//            cell.imgViews.imgWidth = kPhotosImgHeight2
...
//        }else{
//            cell.imgViews.isHidden = false
//            cell.imgViews.imgHight = kPhotosImgHeight3
//            cell.imgViews.imgWidth = kPhotosImgHeight3
