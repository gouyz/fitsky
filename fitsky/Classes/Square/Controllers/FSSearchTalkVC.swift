...
private let searchTalkCell = "searchTalkCell"

class FSSearchTalkVC: GYZWhiteNavBaseVC {
    ...
    lazy var tableView : UITableView = {
        ...
        table.register(FSSearchTalkCell.classForCoder(), forCellReuseIdentifier: searchTalkCell)
...
extension FSSearchTalkVC: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: searchTalkCell) as! FSSearchTalkCell
...
extension FSSearchTalkVC: JXPagingViewListViewDelegate {
