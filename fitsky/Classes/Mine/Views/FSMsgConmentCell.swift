...
class FSMsgConmentCell: UITableViewCell {
        ...
        didSet{
            if let model = dataModel {
                ...
                if model.push_type == "3" {// 评论
                    ...
                    bgContentView.isHidden = false
                    contentLab.text = "我的评论：" + model.comment_content!
                }
                conmentLab.text = model.content
    ...
    func setupUI(){
        ...
        conmentLab.snp.makeConstraints { (make) in
        ...
        bgContentView.snp.makeConstraints { (make) in
            ...
            make.top.equalTo(conmentLab.snp.bottom).offset(5)
        }
