...
private let myFollowAndFenSiListCell = "myFollowAndFenSiListCell"

class FSMyFollowAndFenSiVC: GYZWhiteNavBaseVC {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = typeIndex == 0 ? "我的关注" : "我的粉丝"
    ...
    lazy var tableView : UITableView = {
        ...
        table.register(FSSearchUserCell.classForCoder(), forCellReuseIdentifier: myFollowAndFenSiListCell)
...
extension FSMyFollowAndFenSiVC: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: myFollowAndFenSiListCell) as! FSSearchUserCell
